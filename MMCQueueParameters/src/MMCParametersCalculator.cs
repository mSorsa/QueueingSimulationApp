...
namespace MMCQueueParameters.src
{
    public class MMCParametersCalculator : IMMC
    {
        ...
        public double CalculatePZero()
        {
            ...
            {
                firstHalf += Math.Pow(this._c * rho, n) / this._factorializer.Factorial(n);
            }

            var p1 = Math.Pow(this._c * rho, this._c);
            var p2 = 1.0 / this._factorializer.Factorial(this._c);
            var p3 = 1 / (1 - rho);
        ...
        public double CalculateL()
        {
            ...
            var bottom = this._c * this._factorializer.Factorial(this._c) * Math.Pow(1 - rho, 2);
